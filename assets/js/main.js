$(document).ready(function() {
	...
	$('#main #about .workFlow').waypoint(function () {
	    ...
	    $('#main #about .workFlow ul li.collaborate').addClass('animate');
	    setTimeout(function () {
	        $('#main #about .workFlow ul li.strategize').addClass('animate');
	    }, 1200);
	    setTimeout(function () {
	        $('#main #about .workFlow ul li.dev').addClass('animate');
	    }, 2400);
	    setTimeout(function () {
	        $('#main #about .workFlow ul li.implement').addClass('animate');
	    }, 3600);
	},
	{
	    offset: '65%',
	...
	$('.gallery .shotWrapper').click(function(e) {
		e.preventDefault();
		var imgSource = $(this).data('img');
		$('body').append('<div class="projectModal"><div class="closeContainer"><a class="close" href="#">Close</a></div><div class="imgContainer"><img class="project" src="'+imgSource+'"/></div></div>');
		$('html, body').animate({
	...
	/* Gallery animation */
	$('#main #services .responsiveDesign').waypoint(function() {
		$(this).addClass( 'animate' );
	},
	{
		offset: '65%',
	...
	$('.contactD3sign').click(function(e) {
    ...
    $('#contactForm').submit(function(){
		...
		var budget = $('#contactForm .budgetAmount').text();
